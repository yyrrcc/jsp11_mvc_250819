...
public class BoardController2 extends HttpServlet {
	...
	public void doAction(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println(System.getenv("DB_PASSWORD")); // 이클립스 run configurations 에서 비밀번호 설정함, 콘솔창에 비밀번호 보여줌
        ...
        if (comm.equals("index.do")) { // 홈화면
        	...
        	viewpage = "index.jsp";
        } else if (comm.equals("boardList.do")) { // 게시판 목록보기 (전체 글, 검색한 글, 개수, 페이징)
        	// 페이징!
